let retornoElemento = document.getElementById('retorno')

function retorno() {
    let nome = prompt('Informe seu nome: ')

    if (nome) {
        retornoElemento.innerText = `Bem vindo, ${nome}`
        ...
        retornoElemento.innerText = `Favor preencha o campo nome, atualize a página ou ${link}`
        retornoElemento.appendChild(link)
    }
}
